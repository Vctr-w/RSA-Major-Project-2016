...
def main():
    ...
    #actual_corners = [[X_OFFSET, 0], [FIELD_WIDTH + X_OFFSET, 0], \
    #	[FIELD_WIDTH + X_OFFSET, FIELD_LENGTH / 2], [X_OFFSET, FIELD_LENGTH / 2]]


    #actual_corners = [[X_OFFSET, Y_OFFSET], [FIELD_WIDTH + X_OFFSET, Y_OFFSET], \
    #	[FIELD_WIDTH + X_OFFSET, FIELD_LENGTH / 2 + Y_OFFSET], [X_OFFSET, FIELD_LENGTH / 2 + Y_OFFSET]]
